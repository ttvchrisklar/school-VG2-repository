...
def visebilety():
    ...
    visebilety_up = [player_list[0].location - grid_width, player_list[0].location - grid_width*2, player_list[0].location - (grid_width*2)-1, player_list[0].location - (grid_width*2)+1, player_list[0].location - grid_width*3, player_list[0].location - (grid_width*3)-1,player_list[0].location - (grid_width*3)+1, player_list[0].location - (grid_width*3)-2 ,player_list[0].location - (grid_width*3)+2,player_list[0].location - grid_width*4, player_list[0].location - (grid_width*4)-1,player_list[0].location - (grid_width*4)+1, player_list[0].location - (grid_width*4)-2 ,player_list[0].location - (grid_width*4)+2,player_list[0].location - (grid_width*4)+3,player_list[0].location - (grid_width*4)-3]
    ...
    visebilety_left = [player_list[0].location + 1, player_list[0].location + 2, player_list[0].location + 3, player_list[0].location + (grid_width)+2,player_list[0].location - (grid_width)+2,player_list[0].location + (grid_width)+3,player_list[0].location - (grid_width)+3, player_list[0].location + (grid_width*2)+3,player_list[0].location - (grid_width*2)+3, player_list[0].location + (grid_width*2)+4,player_list[0].location - (grid_width*2)+4, player_list[0].location + (grid_width)+4,player_list[0].location - (grid_width)+4 ,player_list[0].location + 4, player_list[0].location + (grid_width*3)+4,player_list[0].location - (grid_width*3)+4]
    visebilety_right = [player_list[0].location - 1, player_list[0].location - 2, player_list[0].location - 3, player_list[0].location - (grid_width)-2,player_list[0].location + (grid_width)-2,player_list[0].location - (grid_width)-3,player_list[0].location + (grid_width)-3, player_list[0].location - (grid_width*2)-3,player_list[0].location + (grid_width*2)-3,player_list[0].location + (grid_width)-4, player_list[0].location - (grid_width*2)-4,player_list[0].location + (grid_width*2)-4,player_list[0].location - (grid_width*1)-4,player_list[0].location -4, player_list[0].location - (grid_width*3)-4,player_list[0].location + (grid_width*3)-4]
